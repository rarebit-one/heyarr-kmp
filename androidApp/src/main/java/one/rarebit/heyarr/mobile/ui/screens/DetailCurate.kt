 ...
 */
@Composable
internal fun CurateTab(session: AppSession, work: Work, type: MediaType, wants: List<DesiredItem>, state: DetailState, seasons: List<Season>, onOpen: (Route) -> Unit, reload: () -> Unit) {
    val scope = rememberCoroutineScope()
    val assets = state.assets.orEmpty()
